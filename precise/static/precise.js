document.addEventListener('DOMContentLoaded', function() {
    ...
    const input = document.querySelectorAll(".finder__input").forEach(input => {
    input.onclick = function() { 

      const finder = document.getElementsByClassName(`finder ${this.dataset.section}`);      
      const form = document.querySelector("form");
      console.log(document.querySelector("form"))
      console.log(finder)
  
    
      finder[0].classList.add("active");
      console.log('1')
    
      input.addEventListener("blur",() => {
        if (input.value.length === 0) {
          finder[0].classList.remove("active");
        }
      });
...
var phrase = document.getElementById('2')
var blurphrase = document.getElementById('second_container')
var blurtitle = document.getElementById('container')
...
function myFunction() {
  ...
  if (demo.innerHTML != '') {
    ...
    blurphrase.style.filter = 'blur(1px)';
  ...
  if (demo.innerHTML == '') {
    phrase.disabled = false;
    blurphrase.style.filter = 'blur(0px)'; 
  }
}
...
function myFunction2() {
  ...
  if (demo.innerHTML != '') {
    title.disabled = true;
    blurtitle.style.filter = 'blur(1px)';
    search.addEventListener('click',function() {
  ...
  if (demo.innerHTML == '') {
    title.disabled = false;
    blurtitle.style.filter = 'blur(0px)'; 
  }
}
...
(function() {
  ...
  CuteSelect.tools = {
      ...
      if(SOMETHINGOPEN) {
        ...
        for (var i = 0; i < cells.length; i++) {
          if(cells[i].hasAttribute('data-cuteselect-options')) { 
            ...
            document.getElementById('vertical_line_2').style.display = 'block';
            document.getElementById('vertical_line_3').style.display = 'block';
    ...
    show: function(item) {
      ...
      document.getElementById('vertical_line_2').style.display = 'none';
      document.getElementById('vertical_line_3').style.display = 'none';
